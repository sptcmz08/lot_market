...
class PublicBookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'tent_quantity.required_if' => 'กรุณาระบุจำนวนเต็นท์',
            'tent_quantity.min' => 'จำนวนเต็นท์ต้องอย่างน้อย 1 หลัง',
            'counter_size.required_if' => 'กรุณาเลือกขนาดเคาน์เตอร์',
            'counter_quantity.required_if' => 'กรุณาระบุจำนวนเคาน์เตอร์',
            'counter_quantity.min' => 'จำนวนเคาน์เตอร์ต้องอย่างน้อย 1 ชุด',
